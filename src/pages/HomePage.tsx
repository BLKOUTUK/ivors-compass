...
export default function HomePage() {
  ...
  return (
    <div className="space-y-4 stagger">
      ...
      {/* Daily Convergence Card — prominent, before main grid */}
      <Link
        to="/compass/convergence"
        className="block bg-gradient-to-br from-compass-dark to-compass-card border border-gold/30 hover:border-gold/50 rounded-xl p-5 transition-all active:scale-[0.98] hover:shadow-[0_0_32px_rgba(212,175,55,0.15)]"
          ...
          <div className="flex-1 min-w-0">
            ...
            {snapshot ? (
              ...
              <>
                ...
                <p className="text-text-muted/50 text-xs mt-1">Today&apos;s affirmation + anonymous reflections</p>
              </>
            )}
          </div>
          <svg className="w-5 h-5 text-gold/40 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {/* Heritage Meditations — tall (spans 2 rows on sm+) */}
        <BentoCard to="/compass/meditation/1" className="sm:row-span-2 border-terracotta/20 hover:border-terracotta/40">
          <div className="flex flex-col h-full gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-text-muted/50 text-xs mt-1">6 writers · 6 chapters</p>
            </div>
            <div className="space-y-1.5 mt-2">
              ...
              <p className="text-text-muted/30 text-[10px] pl-7">+ 3 more chapters</p>
            </div>
          </div>
        </BentoCard>

        {/* Affirmation Cards — standard */}
        <BentoCard to="/compass/cards">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">Deck of 30+</p>
            </div>
          </div>
        </BentoCard>

        {/* Mood Check-in — standard */}
        <BentoCard to="/compass/mood">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">Track patterns · Suggest journal phases</p>
            </div>
          </div>
        </BentoCard>

        {/* Workshops — standard */}
        <BentoCard to="/compass/workshops" className="border-terracotta/20 hover:border-terracotta/40">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">6 workshops · Anxiety, Anger, Shame & more</p>
            </div>
          </div>
        </BentoCard>

        {/* The Sunroom — warm gold, inviting */}
        <BentoCard to="/compass/sunroom" className="sm:col-span-2 border-[#D4AF37]/30 hover:border-[#D4AF37]/50">
          <div className="flex items-start gap-4">
            <div className="mt-0.5 flex-shrink-0">
              <svg className="w-7 h-7 text-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">Laughter notes · Community highlights · AIvor chat</p>
            </div>
            <svg className="w-5 h-5 text-gold/40 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            </svg>
        ...
        {/* Journal — wide (spans 2 cols on sm+) */}
        <BentoCard to="/compass/journal" className="sm:col-span-2">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">Never leaves your phone</p>
            </div>
            <svg className="w-5 h-5 text-text-muted/30 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
            </svg>
        ...
        {/* Sacred Momentum — progress tracking */}
        <BentoCard to="/compass/progress" className="sm:col-span-1 border-[#D4AF37]/20 hover:border-[#D4AF37]/40">
          <div className="flex items-start gap-4">
            <div className="mt-0.5 flex-shrink-0">
              <svg className="w-6 h-6 text-gold-rich" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-text-muted/50 text-xs mt-1">5-month cycle · Milestones · Phase wisdom</p>
            </div>
          </div>
        </BentoCard>

        {/* Crisis Support — full width, subtle */}
        <div className="sm:col-span-2">
          ...
          >
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 text-red-400/70 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
              </svg>
              <div className="flex-1 min-w-0">
                <p className="text-white/80 text-sm font-medium">Need Support?</p>
                <p className="text-text-muted/50 text-xs">Crisis helplines, grounding exercises, and care</p>
              </div>
              <span className="text-red-400/50 text-xs flex-shrink-0">Get help now</span>
            </div>
          </Link>
        </div>

        {/* About — small */}
        <BentoCard to="/compass/about" className="sm:col-span-1 border-compass-border hover:border-gold/30">
          <div className="flex items-center gap-3">
            <WarmthOrb intensity={0.3} color="#D4AF37" size={16} />
            <div>
              <p className="text-white text-sm font-medium">About Ivor Cummings</p>
              <p className="text-text-muted/50 text-xs">The gay father of Windrush · 1913–1992</p>
            </div>
          </div>
        </BentoCard>
      </div>
