...
export const affirmations: AffirmationCard[] = [
  ...
  { id: 2, text: 'My existence is not a contradiction. I am Black. I am queer. I am whole.', attribution: 'after Audre Lorde', phase: 'identity' },
  { id: 3, text: 'I do not need permission to take up space. The space was always mine.', phase: 'identity' },
  { id: 4, text: 'I am learning to trust the wisdom my body has been holding for me.', attribution: 'after Resmaa Menakem', phase: 'identity' },
  { id: 5, text: 'Today I choose to see myself through my own eyes, not theirs.', attribution: 'after James Baldwin', phase: 'identity' },
  ...
  { id: 33, text: 'I am not who they said I was. I am who I have always known myself to be.', attribution: 'after James Baldwin', phase: 'identity' },
  { id: 34, text: 'My name, my skin, my desire — none of these are problems to be solved.', attribution: 'after Audre Lorde', phase: 'identity' },
  { id: 35, text: 'I am still becoming. That is not a failure. That is the work of a life.', attribution: 'after Michelle Obama', phase: 'identity' },
  { id: 36, text: 'I honour the version of me who survived long enough to arrive here.', phase: 'identity' },
  { id: 37, text: 'My body is not evidence. My body is home.', attribution: 'after Resmaa Menakem', phase: 'identity' },
  ...
  { id: 9, text: 'My vulnerability is not weakness. It is the doorway through which connection enters.', attribution: 'after Bren\u00e9 Brown', phase: 'connection' },
  { id: 10, text: 'I do not have to earn belonging. I belong because I exist.', attribution: 'after adrienne maree brown', phase: 'connection' },
  ...
  { id: 13, text: 'I am part of a lineage of care. Someone stood on a dock to welcome someone they\'d never met.', attribution: 'after Ivor Cummings', phase: 'connection' },
  ...
  { id: 19, text: 'I can work within a system without letting the system work its way into me.', attribution: 'after Audre Lorde', phase: 'resistance' },
  { id: 20, text: 'My anger is information. It is telling me where my values are being crossed.', attribution: 'after Audre Lorde', phase: 'resistance' },
  { id: 21, text: 'I protect my peace not because I am fragile but because my peace is valuable.', phase: 'resistance' },
  { id: 22, text: 'I am allowed to rest. Exhaustion is not a prerequisite for worthiness.', attribution: 'after Tricia Hersey', phase: 'resistance' },
  { id: 23, text: 'Being invisible was never my choice. Being visible is.', phase: 'resistance' },
  { id: 42, text: 'I do not owe anyone a palatable version of my truth.', attribution: 'after Audre Lorde', phase: 'resistance' },
  ...
  { id: 45, text: 'Rest is not retreat. It is how I sharpen myself for what matters.', attribution: 'after Tricia Hersey', phase: 'resistance' },
  ...
  { id: 25, text: 'My joy is an act of resistance in a world that would rather see me suffer.', attribution: 'after Toni Morrison', phase: 'joy' },
  ...
  { id: 28, text: 'My freedom is not a future event. It is something I practise every day.', attribution: 'after bell hooks', phase: 'joy' },
  ...
  { id: 31, text: 'Today, I choose delight.', attribution: 'after Ross Gay', phase: 'joy' },
  ...
  { id: 47, text: 'I deserve pleasure without a permission slip.', attribution: 'after adrienne maree brown', phase: 'joy' },
  ...
  { id: 52, text: 'The silence ends with me.', attribution: 'after Audre Lorde', phase: 'resistance' },
]
